...
public function products_reports($filtraDia=0, $filtrarMes=0)
{
    ...
    $productsQuery = $productsQuery->groupBy(
            'products.id',
            'products.name',
            // 'products.image', // QUITADO del groupBy también
            'items.product_id'
        )
